            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <div class="dropdown">
                        ...
                        <li><a class="dropdown-item text-white" href="partial/profile.php"><i class="fa-solid fa-user"></i> Profile</a></li>
                        <li><a class="dropdown-item text-white" href="partial/myfee.php"><i class="fa-brands fa-first-order-alt"></i> My Fee</a></li>
                        <li><a class="dropdown-item text-white" href="partial/changeuspassword.php"><i class="fa-solid fa-key"></i>change password</a></li>
                            <div class="dropdown-divider"></div>
                        <li><a class="dropdown-item text-white" href="partial/logout.php"> <i class="fa-solid fa-right-from-bracket"></i>Logout</a></li>
                ...
                <div class="my-4" style="display: block;" id="id1">
                    <form action="" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control"  value =""  id="uspassword" name="password" required>
                        </div>
